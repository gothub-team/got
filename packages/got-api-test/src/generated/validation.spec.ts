    ...
    "additionalProperties": {
      "additionalProperties": false
        ...
        describe('additionalProperties', () => {
                        ...
                        afterEach(() => {
                            propPath.pop();
                        });describe('oneOf', () => {describe('wrong type', () => {
                        it('fails with bad request', async () => {
                            const b = assocPathMutate(propPath, "some string", body as Record<string, unknown>);
                            const res = await fetch(url, {
                                body: JSON.stringify(b),
                            ...
                            beforeEach(() => {
                                assocPathMutate(propPath, {"id":"some string","additionalProperties":"some string"}, body as Record<string, unknown>);
                            });describe('id', () => {
            beforeEach(() => {
                propPath.push('id');
            });
            ...
            describe('wrong type', () => {
                it('fails with bad request', async () => {
                    const b = assocPathMutate(propPath, [
  "some array"
                    ...
                    expect(resBody).toInclude('string');
                        ...
                        afterEach(() => {
                            propPath.pop();
                        });describe('oneOf', () => {describe('string', () => {
                            beforeEach(() => {
        ...
        describe('additionalProperties', () => {
                        ...
                        it('fails with bad request', async () => {
                            ...
                            beforeEach(() => {
                                assocPathMutate(propPath, {"additionalProperties":"some string"}, body as Record<string, unknown>);
                            });describe('additionalProperties', () => {
                        beforeEach(() => {
                            propPath.push('additionalProperties');
                        });
  ...
  "some array"
        ...
        describe('additionalProperties', () => {
                        ...
                        it('fails with bad request', async () => {
                            ...
                            beforeEach(() => {
                                assocPathMutate(propPath, {"filename":"some string","contentType":"some string","fileSize":100,"partSize":5242880}, body as Record<string, unknown>);
                            });describe('filename', () => {
            beforeEach(() => {
