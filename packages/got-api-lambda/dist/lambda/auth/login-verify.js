...
var g = (t, e) => () => (e || t((e = { exports: {} }).exports, e), e.exports),
    ...
    Js = (t, e, r, s) => {
        if ((e && typeof e == 'object') || typeof e == 'function')
            for (let n of Ga(e))
                !Wa.call(t, n) && n !== r && St(t, n, { get: () => e[n], enumerable: !(s = Ha(e, n)) || s.enumerable });
        return t;
    };
var Qa = (t, e, r) => (
        (r = t != null ? Ka(Ja(t)) : {}),
        Js(e || !t || !t.__esModule ? St(r, 'default', { value: t, enumerable: !0 }) : r, t)
    ),
    Xa = (t) => Js(St({}, '__esModule', { value: !0 }), t);
var Ye = g((O) => {
    'use strict';
    ...
    function on(t, ...e) {
        let r = [t[0]],
            s = 0;
        for (; s < e.length; ) ur(r, e[s]), r.push(t[++s]);
        return new Q(r);
    }
    O._ = on;
    var cr = new Q('+');
    function an(t, ...e) {
        let r = [Xe(t[0])],
            s = 0;
        for (; s < e.length; ) r.push(cr), ur(r, e[s]), r.push(cr, Xe(t[++s]));
        return ri(r), new Q(r);
    }
    O.str = an;
    function ur(t, e) {
    ...
    function ni(t, e) {
        return e.emptyStr() ? t : t.emptyStr() ? e : an`${t}${e}`;
    }
    O.strConcat = ni;
    function oi(t) {
    ...
    O.safeStringify = Xe;
    function ii(t) {
        return typeof t == 'string' && O.IDENTIFIER.test(t) ? new Q(`.${t}`) : on`[${t}]`;
    }
    O.getProperty = ii;
    function ci(t) {
        ...
        lr = class extends Nt {
            constructor(e) {
                super(e),
                    (this._values = {}),
                    (this._scope = e.scope),
                    (this.opts = { ...e, _n: e.lines ? di : G.nil });
            }
            get() {
                return this._scope;
            }
            ...
            value(e, r) {
                ...
                let c = this._scope[o] || (this._scope[o] = []),
                    d = c.length;
                return (c[d] = r.ref), n.setValue(r, { property: o, itemIndex: d }), n;
            }
            getValue(e, r) {
            ...
            _reduceValues(e, r, s = {}, n) {
                ...
                for (let a in e) {
                    ...
                    i.forEach((d) => {
                        ...
                        let u = r(d);
                        if (u) {
                            let l = this.opts.es5 ? J.varKinds.var : J.varKinds.const;
                            o = (0, G._)`${o}${l} ${d} = ${u};${this.opts._n}`;
                        } else if ((u = n?.(d))) o = (0, G._)`${o}${u}${this.opts._n}`;
                        else throw new dr(d);
                        c.set(d, Pt.Completed);
                    });
                }
                return o;
            }
...
var S = g((b) => {
    ...
    var le = class {
        ...
        Ze = class extends le {
            ...
            optimizeNames(e, r) {
                ...
                for (; n--; ) {
                    let o = s[n];
                    o.optimizeNames(e, r) || (li(e, o.names), s.splice(n, 1));
                }
    ...
    var Pe = class t extends fe {
        ...
        optimizeNodes() {
            ...
            if (r)
                return e === !1
                    ...
                    : this.nodes.length
                      ? this
                      : new t(cn(e), r instanceof t ? [r] : r.nodes);
        ...
        get names() {
            let e = super.names;
            return Ot(e, this.condition), this.else && Re(e, this.else.names), e;
        }
    };
    Pe.kind = 'if';
    ...
    var vr = class extends Ne {
        ...
        wr = class extends Ne {
            ...
            get names() {
                let e = Ot(super.names, this.from);
                return Ot(e, this.to);
            }
        },
        kt = class extends Ne {
...
`
        ...
        _def(e, r, s, n) {
            ...
            return s !== void 0 && n && (this._constants[o.str] = s), this._leafNode(new hr(e, o, s)), o;
        }
        const(e, r, s) {
        ...
        add(e, r) {
            return this._leafNode(new pr(e, b.operators.ADD, r));
        }
        code(e) {
            return typeof e == 'function' ? e() : e !== R.nil && this._leafNode(new _r(e)), this;
        }
        object(...e) {
            let r = ['{'];
            for (let [s, n] of e)
        ...
        forOf(e, r, s, n = ee.varKinds.const) {
            ...
            return this._for(new kt('of', n, o, r), () => s(o));
        }
        forIn(e, r, s, n = this.opts.es5 ? ee.varKinds.var : ee.varKinds.const) {
            ...
            let o = this._scope.toName(e);
            return this._for(new kt('in', n, o, r), () => s(o));
        }
        endFor() {
    ...
    b.not = cn;
    var fi = un(b.operators.AND);
    function hi(...t) {
        return t.reduce(fi);
    }
    b.and = hi;
    var pi = un(b.operators.OR);
    function mi(...t) {
        return t.reduce(pi);
    }
    b.or = mi;
...
var T = g((P) => {
    ...
    P.toHash = gi;
    function _i(t, e) {
        return typeof e == 'boolean' ? e : Object.keys(e).length === 0 ? !0 : (fn(t, e), !hn(e, t.self.RULES.all));
    }
    P.alwaysValidSchema = _i;
    function fn(t, e = t.schema) {
        let { opts: r, self: s } = t;
        if (!r.strictSchema || typeof e == 'boolean') return;
        let n = s.RULES.keywords;
        for (let o in e) n[o] || yn(t, `unknown keyword: "${o}"`);
    }
    P.checkUnknownRules = fn;
    function hn(t, e) {
    ...
    P.schemaRefOrVal = vi;
    function wi(t) {
        return pn(decodeURIComponent(t));
    }
    P.unescapeFragment = wi;
    function Ei(t) {
        return encodeURIComponent(Nr(t));
    }
    P.escapeFragment = Ei;
    function Nr(t) {
        return typeof t == 'number' ? `${t}` : t.replace(/~/g, '~0').replace(/\//g, '~1');
    }
    P.escapeJsonPointer = Nr;
    function pn(t) {
        return t.replace(/~1/g, '/').replace(/~0/g, '~');
    }
    P.unescapeJsonPointer = pn;
    function bi(t, e) {
    ...
    P.mergeEvaluated = {
        props: dn({
            ...
            mergeToName: (t, e, r) =>
                t.if((0, C._)`${r} !== true`, () => {
                    e === !0 ? t.assign(r, !0) : (t.assign(r, (0, C._)`${r} || {}`), Rr(t, r, e));
                }),
    ...
    function mn(t, e) {
        ...
        return e !== void 0 && Rr(t, r, e), r;
    }
    P.evaluatedPropsToName = mn;
    function Rr(t, e, r) {
    ...
    function Pi(t, e, r) {
        ...
        return r ? (0, C.getProperty)(t).toString() : `/${Nr(t)}`;
    }
    P.getErrorPath = Pi;
    function yn(t, e, r = t.opts.strictSchema) {
        if (r) {
            if (((e = `strict mode: ${e}`), r === !0)) throw new Error(e);
            t.self.logger.warn(e);
        }
    }
    P.checkStrictMode = yn;
});
var he = g((Ir) => {
    'use strict';
...
var nt = g((L) => {
    ...
    var k = S(),
        qt = T(),
        K = he();
    L.keywordError = { message: ({ keyword: t }) => (0, k.str)`must pass "${t}" keyword validation` };
    L.keyword$DataError = {
    ...
    function Ii(t, e = L.keywordError, r) {
        let { it: s } = t,
            ...
            i = $n(t, e, r);
        gn(n, i), o || a || _n(s, K.default.vErrors);
    }
    L.reportExtraError = Ii;
    function ki(t, e) {
        t.assign(K.default.errors, e),
            t.if((0, k._)`${K.default.vErrors} !== null`, () =>
                t.if(
                    e,
                    () => t.assign((0, k._)`${K.default.vErrors}.length`, e),
                    () => t.assign(K.default.vErrors, null),
                ),
            );
    }
    L.resetErrorsCount = ki;
    function Oi({ gen: t, keyword: e, schemaValue: r, data: s, errsCount: n, it: o }) {
        if (n === void 0) throw new Error('ajv implementation error');
        let a = t.name('err');
        t.forRange('i', n, K.default.errors, (i) => {
            t.const(a, (0, k._)`${K.default.vErrors}[${i}]`),
                t.if((0, k._)`${a}.instancePath === undefined`, () =>
                    t.assign((0, k._)`${a}.instancePath`, (0, k.strConcat)(K.default.instancePath, o.errorPath)),
                ),
                t.assign((0, k._)`${a}.schemaPath`, (0, k.str)`${o.errSchemaPath}/${e}`),
                o.opts.verbose && (t.assign((0, k._)`${a}.schema`, r), t.assign((0, k._)`${a}.data`, s));
        });
    }
    L.extendErrors = Oi;
    function gn(t, e) {
        let r = t.const('err', e);
        t.if(
            (0, k._)`${K.default.vErrors} === null`,
            () => t.assign(K.default.vErrors, (0, k._)`[${r}]`),
            (0, k._)`${K.default.vErrors}.push(${r})`,
        ),
            t.code((0, k._)`${K.default.errors}++`);
    }
    function _n(t, e) {
        let { gen: r, validateName: s, schemaEnv: n } = t;
        n.$async
            ? r.throw((0, k._)`new ${t.ValidationError}(${e})`)
            : (r.assign((0, k._)`${s}.errors`, e), r.return(!1));
    }
    var Ie = {
    ...
    function qi({ errorPath: t }, { instancePath: e }) {
        let r = e ? (0, k.str)`${t}${(0, qt.getErrorPath)(e, qt.Type.Str)}` : t;
        return [K.default.instancePath, (0, k.strConcat)(K.default.instancePath, r)];
    }
    function Ci({ keyword: t, it: { errSchemaPath: e } }, { schemaPath: r, parentSchema: s }) {
        let n = s ? e : (0, k.str)`${e}/${t}`;
        return r && (n = (0, k.str)`${n}${(0, qt.getErrorPath)(r, qt.Type.Str)}`), [Ie.schemaPath, n];
    }
    function Ai(t, { params: e, message: r }, s) {
        let { keyword: n, data: o, schemaValue: a, it: i } = t,
            { opts: c, propertyName: d, topSchemaRef: u, schemaPath: l } = i;
        s.push([Ie.keyword, n], [Ie.params, typeof e == 'function' ? e(t) : e || (0, k._)`{}`]),
            c.messages && s.push([Ie.message, typeof r == 'function' ? r(t) : r]),
            c.verbose && s.push([Ie.schema, a], [Ie.parentSchema, (0, k._)`${u}${l}`], [K.default.data, o]),
            d && s.push([Ie.propertyName, d]);
    }
});
var wn = g((De) => {
    'use strict';
...
var Or = g((_e) => {
    ...
    function En(t, e) {
        return e.rules.some((r) => bn(t, r));
    }
    _e.shouldUseGroup = En;
    function bn(t, e) {
        var r;
        return (
            t[e.keyword] !== void 0 ||
...
var ot = g((F) => {
    ...
    function Qi(t, e) {
        ...
        if (a) {
            let i = qr(e, s, n.strictNumbers, Ve.Wrong);
            r.if(i, () => {
                o.length ? Yi(t, e, o) : Cr(t);
            });
        }
        return a;
    }
    F.coerceAndCheckDataType = Qi;
    var Nn = new Set(['string', 'number', 'integer', 'boolean', 'null']);
    function Xi(t, e) {
        return e ? t.filter((r) => Nn.has(r) || (e === 'array' && r === 'array')) : [];
    }
    function Yi(t, e, r) {
        ...
        for (let d of r) (Nn.has(d) || (d === 'array' && o.coerceTypes === 'array')) && c(d);
        s.else(),
            Cr(t),
            s.endIf(),
            s.if((0, E._)`${i} !== undefined`, () => {
    ...
    function Tr(t, e, r, s = Ve.Correct) {
    ...
    F.checkDataType = Tr;
    function qr(t, e, r, s) {
        if (t.length === 1) return Tr(t[0], e, r, s);
        let n,
            o = (0, Sn.toHash)(t);
        if (o.array && o.object) {
        ...
        for (let a in o) n = (0, E.and)(n, Tr(a, e, r, s));
        return n;
    }
    F.checkDataTypes = qr;
    var ec = {
    ...
    F.reportTypeError = Cr;
    function tc(t) {
        let { gen: e, data: r, schema: s } = t,
            n = (0, Sn.schemaRefOrVal)(t, s, 'type');
        return {
            gen: e,
            keyword: 'type',
            data: r,
...
var In = g((Ct) => {
    ...
    function sc(t, e) {
        ...
        if (e === 'object' && r) for (let n in r) Rn(t, n, r[n].default);
        else e === 'array' && Array.isArray(s) && s.forEach((n, o) => Rn(t, o, n.default));
    }
...
var X = g((q) => {
    ...
    function ac({ gen: t, data: e, it: { opts: r } }, s, n) {
        return (0, j.or)(...s.map((o) => (0, j.and)(Mr(t, e, o, r.ownProperties), (0, j._)`${n} = ${o}`)));
    }
    ...
    q.noPropertyInData = Mr;
    function On(t) {
        return t ? Object.keys(t).filter((e) => e !== '__proto__') : [];
    }
    q.allSchemaProperties = On;
    function uc(t, e) {
        return On(e).filter((r) => !(0, Ar.alwaysValidSchema)(t, e[r]));
    }
    ...
    function dc(
        ...
        let y = (0, j._)`${u}, ${r.object(...l)}`;
        return c !== j.nil ? (0, j._)`${i}.call(${c}, ${y})` : (0, j._)`${i}(${y})`;
    }
    q.callValidateCode = dc;
    var lc = (0, j._)`new RegExp`;
    function fc({ gen: t, it: { opts: e } }, r) {
        ...
        return t.scopeValue('pattern', {
            key: o.toString(),
            ref: o,
            code: (0, j._)`${n.code === 'new RegExp' ? lc : (0, nc.useFunc)(t, n)}(${r}, ${s})`,
        });
    }
    q.usePattern = fc;
    function hc(t) {
        ...
        function a(i) {
            ...
            e.forRange('i', 0, c, (d) => {
                t.subschema({ keyword: s, dataProp: d, dataPropType: Ar.Type.Num }, o), e.if((0, j.not)(o), i);
            });
        }
    }
    q.validateArray = hc;
    function pc(t) {
        ...
        if (r.some((c) => (0, Ar.alwaysValidSchema)(n, c)) && !n.opts.unevaluated) return;
        let a = e.let('valid', !1),
            i = e.name('_valid');
        e.block(() =>
            r.forEach((c, d) => {
                let u = t.subschema({ keyword: s, schemaProp: d, compositeRule: !0 }, i);
...
var Cn = g((ae) => {
    ...
    function _c(t, e) {
        ...
        vc(c, e);
        let d = !i && e.compile ? e.compile.call(c.self, o, a, c) : e.validate,
            u = qn(s, n, d),
            l = s.let('valid');
        t.block$data(l, y), t.ok((r = e.valid) !== null && r !== void 0 ? r : l);
        function y() {
            if (e.errors === !1) f(), e.modifying && Tn(t), p(() => t.error());
            else {
                let _ = e.async ? m() : h();
                e.modifying && Tn(t), p(() => $c(t, _));
            }
        }
        function m() {
        ...
        function f(_ = e.async ? (0, H._)`await ` : H.nil) {
            let I = c.opts.passContext ? ke.default.this : ke.default.self,
                N = !(('compile' in e && !i) || e.schema === !1);
            s.assign(l, (0, H._)`${_}${(0, mc.callValidateCode)(t, u, I, N)}`, e.modifying);
        }
        function p(_) {
            var I;
            s.if((0, H.not)((I = e.valid) !== null && I !== void 0 ? I : l), _);
        }
    }
        ...
        r.if(
            ...
            () => {
                r
                    .assign(
                        ke.default.vErrors,
                        (0, H._)`${ke.default.vErrors} === null ? ${e} : ${ke.default.vErrors}.concat(${e})`,
                    )
                    .assign(ke.default.errors, (0, H._)`${ke.default.vErrors}.length`),
                    (0, yc.extendErrors)(t);
            },
            () => t.error(),
        );
...
var jn = g((ve) => {
        ...
        if (e !== void 0) {
            ...
            return r === void 0
                ...
                : {
                      ...
                      errSchemaPath: `${t.errSchemaPath}/${e}/${(0, An.escapeFragment)(r)}`,
                  };
        }
        if (s !== void 0) {
    ...
    function Sc(t, e, { dataProp: r, dataPropType: s, data: n, dataTypes: o, propertyName: a }) {
        ...
        let { gen: i } = e;
        if (r !== void 0) {
            let { errorPath: d, dataPathArr: u, opts: l } = e,
                y = i.let('data', (0, ie._)`${e.data}${(0, ie.getProperty)(r)}`, !0);
            c(y),
                (t.errorPath = (0, ie.str)`${d}${(0, An.getErrorPath)(r, s, l.jsPropertySyntax)}`),
                (t.parentDataProperty = (0, ie._)`${r}`),
                (t.dataPathArr = [...u, t.parentDataProperty]);
        }
        if (n !== void 0) {
            let d = n instanceof ie.Name ? n : i.let('data', n, !0);
            c(d), a !== void 0 && (t.propertyName = a);
        }
        o && (t.dataTypes = o);
        function c(d) {
            (t.data = d),
...
var Un = g((Oh, Dn) => {
    'use strict';
    var we = (Dn.exports = function (t, e, r) {
    ...
    function At(t, e, r, s, n, o, a, i, c, d) {
            ...
            for (var u in s) {
                ...
                if (Array.isArray(l)) {
                    if (u in we.arrayKeywords)
                        for (var y = 0; y < l.length; y++) At(t, e, r, l[y], `${n}/${u}/${y}`, o, n, u, s, y);
                } else if (u in we.propsKeywords) {
                    if (l && typeof l == 'object')
                        for (var m in l) At(t, e, r, l[m], `${n}/${u}/${Nc(m)}`, o, n, u, s, m);
                } else
                    (u in we.keywords || (t.allKeys && !(u in we.skipKeywords))) &&
                        At(t, e, r, l, `${n}/${u}`, o, n, u, s);
            }
            r(s, n, o, a, i, c, d);
        }
    }
...
var at = g((W) => {
    ...
    function Tc(t, e = !0) {
        return typeof t == 'boolean' ? !0 : e === !0 ? !Ur(t) : e ? Vn(t) <= e : !1;
    }
    W.inlineRef = Tc;
    ...
    function Vn(t) {
        ...
        for (let r in t) {
            ...
            if (
                (e++,
                !Oc.has(r) && (typeof t[r] == 'object' && (0, Rc.eachItem)(t[r], (s) => (e += Vn(s))), e === 1 / 0))
            )
                return 1 / 0;
        }
        return e;
    ...
    function Mc(t, e) {
        ...
        let { schemaId: r, uriResolver: s } = this.opts,
            ...
            c = new Set();
        return (
            kc(t, { allKeys: !0 }, (l, y, m, h) => {
                if (h === void 0) return;
                let f = a + y,
                    p = o[h];
                typeof l[r] == 'string' && (p = _.call(this, l[r])),
                    I.call(this, l.$anchor),
                    I.call(this, l.$dynamicAnchor),
                    (o[y] = p);
                function _(N) {
                    ...
                    return (
                        ...
                        typeof w == 'object'
                            ? d(l, w.schema, N)
                            : N !== ze(f) && (N[0] === '#' ? (d(l, i[N], N), (i[N] = l)) : (this.refs[N] = f)),
                        N
                    );
                }
                function I(N) {
...
var ut = g((Ee) => {
    ...
    function Vc(t) {
        ...
        Jn(t, () => (0, Gn.topBoolOrEmptySchema)(t));
    }
    Ee.validateFunctionCode = Vc;
    function Jn({ gen: t, validateName: e, schema: r, schemaEnv: s, opts: n }, o) {
        n.code.es5
            ? t.func(e, (0, $._)`${v.default.data}, ${v.default.valCxt}`, s.$async, () => {
                  t.code((0, $._)`"use strict"; ${Fn(r, n)}`), zc(t, n), t.code(o);
              })
            : t.func(e, (0, $._)`${v.default.data}, ${xc(n)}`, s.$async, () => t.code(Fn(r, n)).code(o));
    }
    function xc(t) {
        return (0,
    ...
    function Hc(t, e) {
        ...
        n.$comment && r.$comment && Yn(t), Wc(t), Bc(t);
        let o = s.const('_errs', v.default.errors);
        Xn(t, o), s.var(e, (0, $._)`${o} === ${v.default.errors}`);
    }
    function Qn(t) {
        (0, pe.checkUnknownRules)(t), Gc(t);
    }
    function Xn(t, e) {
        if (t.opts.jtd) return Kn(t, [], !1, e);
        let r = (0, Ln.getSchemaTypes)(t.schema),
            s = (0, Ln.coerceAndCheckDataType)(t, r);
        Kn(t, r, !s, e);
    }
    function Gc(t) {
    ...
    function Yn({ gen: t, schemaEnv: e, schema: r, errSchemaPath: s, opts: n }) {
        let o = r.$comment;
    ...
    function Kn(t, e, r, s) {
        let { gen: n, schema: o, data: a, allErrors: i, opts: c, self: d } = t,
            { RULES: u } = d;
        if (o.$ref && (c.ignoreKeywordsWithRef || !(0, pe.schemaHasRulesButRef)(o, u))) {
            n.block(() => eo(t, '$ref', u.all.$ref.definition));
            return;
        }
        c.jtd || Yc(t, e),
            n.block(() => {
                for (let y of u.rules) l(y);
                l(u.post);
            });
        function l(y) {
            (0, xr.shouldUseGroup)(o, y) &&
                (y.type
    ...
    function Hn(t, e) {
        ...
        n && (0, Dc.assignDefaults)(t, e.type),
            r.block(() => {
                for (let o of e.rules) (0, xr.shouldUseRule)(s, o) && eo(t, o.keyword, o.definition, e.type);
            });
    }
    function Yc(t, e) {
    ...
    function Zc(t, e) {
        if (e.length) {
            ...
            e.forEach((r) => {
                Zn(t.dataTypes, r) || zr(t, `type "${r}" not allowed by context "${t.dataTypes.join(',')}"`);
            }),
                su(t, e);
        }
    }
    ...
    function tu(t, e) {
        ...
        for (let s in r) {
            let n = r[s];
            if (typeof n == 'object' && (0, xr.shouldUseRule)(t.schema, n)) {
                let { type: o } = n.definition;
                o.length && !o.some((a) => ru(e, a)) && zr(t, `missing type "${o.join(',')}" for keyword "${s}"`);
            }
        }
    }
    function ru(t, e) {
    ...
    function su(t, e) {
        let r = [];
        for (let s of t.dataTypes) Zn(e, s) ? r.push(s) : e.includes('integer') && s === 'number' && r.push('integer');
        t.dataTypes = r;
    }
    function zr(t, e) {
    ...
    var Mt = class {
        constructor(e, r, s) {
            if (
                ...
                this.schemaCode = e.gen.const('vSchema', to(this.$data, e));
            else if (
        ...
        subschema(e, r) {
            ...
            (0, Vr.extendSubschemaData)(s, this.it, e), (0, Vr.extendSubschemaMode)(s, e);
    ...
    var nu = /^\/(?:[^~]|~0|~1)*$/,
        ou = /^([0-9]+)(#|\/(?:[^~]|~0|~1)*)?$/;
    function to(t, { dataLevel: e, dataNames: r, dataPathArr: s }) {
        let n, o;
        ...
        if (t[0] === '/') {
            ...
            let d = ou.exec(t);
            if (!d) throw new Error(`Invalid JSON-pointer: ${t}`);
            let u = +d[1];
            if (((n = d[2]), n === '#')) {
        ...
        for (let d of i)
            d &&
                ((o = (0, $._)`${o}${(0, $.getProperty)((0, pe.unescapeJsonPointer)(d))}`),
                (a = (0, $._)`${a} && ${o}`));
        return a;
        function c(d, u) {
        ...
        Hr = class extends Error {
            constructor(e, r, s, n) {
                super(n || `can't resolve reference ${s} from id ${r}`),
                    (this.missingRef = (0, Kr.resolveUrl)(e, r, s)),
                    (this.missingSchema = (0, Kr.normalizeId)((0, Kr.getFullPath)(e, this.missingRef)));
            }
        };
    Gr.default = Hr;
});
var Vt = g((Y) => {
    ...
    function Wr(t) {
        ...
        let d = {
                ...
                data: Oe.default.data,
                parentData: Oe.default.parentData,
                parentDataProperty: Oe.default.parentDataProperty,
                dataNames: [Oe.default.data],
                dataPathArr: [te.nil],
                dataLevel: 0,
                dataTypes: [],
            ...
            u;
        try {
            this._compilations.add(t), (0, iu.validateFunctionCode)(d), a.optimize(this.opts.code.optimize);
            let l = a.toString();
            (u = `${a.scopeRefs(Oe.default.scope)}return ${l}`),
                this.opts.code.process && (u = this.opts.code.process(u, t));
            let m = new Function(`${Oe.default.self}`, `${Oe.default.scope}`, u)(this, this.scope.get());
            if (
    ...
    Y.resolveRef = cu;
    function uu(t) {
        return (0, re.inlineRef)(t.schema, this.opts.inlineRefs) ? t.schema : t.validate ? t : Wr.call(this, t);
    }
    function so(t) {
        for (let e of this._compilations) if (du(e, t)) return e;
    }
    Y.getCompilingSchema = so;
    function du(t, e) {
    ...
    function Ut(t, e) {
        ...
        if (Object.keys(t.schema).length > 0 && s === n) return Jr.call(this, r, t);
        let o = (0, re.normalizeId)(s),
            a = this.refs[o] || this.schemas[o];
        if (typeof a == 'string') {
            let i = Ut.call(this, t, a);
            return typeof i?.schema != 'object' ? void 0 : Jr.call(this, r, i);
        }
        if (typeof a?.schema == 'object') {
            if ((a.validate || Wr.call(this, a), o === (0, re.normalizeId)(e))) {
                let { schema: i } = a,
                    { schemaId: c } = this.opts,
                    d = i[c];
                return (
                    d && (n = (0, re.resolveUrl)(this.opts.uriResolver, n, d)),
    ...
    function Jr(t, { baseId: e, schema: r, root: s }) {
        var n;
        if (((n = t.fragment) === null || n === void 0 ? void 0 : n[0]) !== '/') return;
        for (let i of t.fragment.slice(1).split('/')) {
            if (typeof r == 'boolean') return;
            let c = r[(0, ro.unescapeFragment)(i)];
            if (c === void 0) return;
            r = c;
            let d = typeof r == 'object' && r[this.opts.schemaId];
            !fu.has(i) && d && (e = (0, re.resolveUrl)(this.opts.uriResolver, e, d));
        }
        let o;
        if (typeof r != 'boolean' && r.$ref && !(0, ro.schemaHasRulesButRef)(r, this.RULES)) {
...
var mo = g((Uh, po) => {
    ...
    var { HEX: mu } = ao();
    function lo(t) {
        if (ho(t, '.') < 3) return { host: t, isIPV4: !1 };
        let e =
                t.match(
    ...
    function yu(t) {
        ...
        return (
            n.length && (o ? (r.zone = n.join('')) : i ? s.push(n.join('')) : s.push(Br(n))),
            (r.address = s.join('')),
            r
        );
    }
    function fo(t, e = {}) {
        if (ho(t, ':') < 2) return { host: t, isIPV6: !1 };
        let r = yu(t);
    ...
    function $u(t) {
        let e = [];
        for (; t.length; )
            if (t.match(io)) t = t.replace(io, '');
            else if (t.match(co)) t = t.replace(co, '/');
            else if (t.match(uo)) (t = t.replace(uo, '/')), e.pop();
            else if (t === '.' || t === '..') t = '';
            else {
                let r = t.match(_u);
                if (r) {
...
var wo = g((Vh, vo) => {
    ...
    function Pu(t) {
        if (
            ((t.port === (yo(t) ? 443 : 80) || t.port === '') && (t.port = void 0),
    ...
    var $o = { scheme: 'http', domainHost: !0, parse: go, serialize: _o },
        Ou = { scheme: 'https', domainHost: $o.domainHost, parse: go, serialize: _o },
        ...
        Cu = { scheme: 'urn:uuid', parse: Iu, serialize: ku, skipNormalize: !0 },
        Qr = { http: $o, https: Ou, ws: xt, wss: Tu, urn: qu, 'urn:uuid': Cu };
    vo.exports = Qr;
});
var bo = g((xh, Lt) => {
    'use strict';
    ...
    function ce(t, e) {
        ...
        if (
            ...
            let i = r.path;
            !s.absolutePath && (!o || !o.absolutePath) && (i = lt(i)),
    ...
    function me(t, e) {
        ...
        if (a) {
            if (
                ...
                let c = ju(s.host);
                if (c.isIPV4 === !1) {
                    let d = Au(c.host, { isIPV4: !1 });
                    (s.host = d.host.toLowerCase()), (o = d.isIPV6);
    ...
    var Yr = { SCHEMES: Xr, normalize: Du, resolve: Uu, resolveComponents: Eo, equal: Vu, serialize: ce, parse: me };
    Lt.exports = Yr;
    Lt.exports.default = Yr;
    Lt.exports.fastUri = Yr;
});
var Po = g((Zr) => {
    'use strict';
    Object.defineProperty(Zr, '__esModule', { value: !0 });
    var So = bo();
    So.code = 'require("ajv/dist/runtime/uri").default';
    Zr.default = So;
});
var Co = g((V) => {
    'use strict';
    ...
    var Wu = ['removeAdditional', 'useDefaults', 'coerceTypes'],
        ...
        Ro = 200;
    function Yu(t) {
        var e, r, s, n, o, a, i, c, d, u, l, y, m, h, f, p, _, I, N, A, w, ne, de, or, ar;
        let Be = t.strict,
            ir = (e = t.code) === null || e === void 0 ? void 0 : e.optimize,
            Hs = ir === !0 || ir === void 0 ? 1 : ir || 0,
            Gs = (s = (r = t.code) === null || r === void 0 ? void 0 : r.regExp) !== null && s !== void 0 ? s : To,
            Fa = (n = t.uriResolver) !== null && n !== void 0 ? n : Ju.default;
        return {
            strictSchema:
            ...
            strictTypes:
                (u = (d = t.strictTypes) !== null && d !== void 0 ? d : Be) !== null && u !== void 0 ? u : 'log',
            strictTuples:
                (y = (l = t.strictTuples) !== null && l !== void 0 ? l : Be) !== null && y !== void 0 ? y : 'log',
            strictRequired:
                (h = (m = t.strictRequired) !== null && m !== void 0 ? m : Be) !== null && h !== void 0 ? h : !1,
            code: t.code ? { ...t.code, optimize: Hs, regExp: Gs } : { optimize: Hs, regExp: Gs },
            loopRequired: (f = t.loopRequired) !== null && f !== void 0 ? f : Ro,
            loopEnum: (p = t.loopEnum) !== null && p !== void 0 ? p : Ro,
            ...
            validateFormats: (de = t.validateFormats) !== null && de !== void 0 ? de : !0,
    ...
    var pt = class {
        constructor(e = {}) {
            ...
            (e.validateFormats = !1),
                ...
                Io.call(this, Qu, e, 'NOT SUPPORTED'),
                Io.call(this, Xu, e, 'DEPRECATED', 'warn'),
                (this._metaOpts = rd.call(this)),
                e.formats && ed.call(this),
                this._addVocabularies(),
                this._addDefaultMetaSchema(),
                e.keywords && td.call(this, e.keywords),
        ...
        _addDefaultMetaSchema() {
            let { $data: e, meta: r, schemaId: s } = this.opts,
                n = No;
            s === 'id' && ((n = { ...No }), (n.id = n.$id), delete n.$id), r && e && this.addMetaSchema(n, n[s], !1);
        }
        defaultMeta() {
        ...
        compileAsync(e, r) {
            ...
            async function n(u, l) {
                await o.call(this, u.$schema);
                let y = this._addSchema(u, l);
            ...
            async function a(u) {
                try {
                    ...
                    if (!(l instanceof Oo.default)) throw l;
                    return i.call(this, l), await c.call(this, l.missingSchema), a.call(this, u);
                }
            }
            ...
            async function c(u) {
                let l = await d.call(this, u);
                this.refs[u] || (await o.call(this, l.$schema)), this.refs[u] || this.addSchema(l, u, r);
            }
            async function d(u) {
        ...
        addKeyword(e, r) {
            ...
            if ((ad.call(this, s, r), !r)) return (0, ts.eachItem)(s, (o) => es.call(this, o)), this;
            cd.call(this, r);
            ...
            return (
                (0, ts.eachItem)(
                    ...
                    n.type.length === 0
                        ? (o) => es.call(this, o, n)
                        : (o) => n.type.forEach((a) => es.call(this, o, n, a)),
                ),
                this
            );
        }
        ...
        _addSchema(e, r, s, n = this.opts.validateSchema, o = this.opts.addUsedSchema) {
            ...
            let d = ht.getSchemaRefs.call(this, e, s);
            return (
                (c = new ft.SchemaEnv({ schema: e, schemaId: i, meta: r, baseId: s, localRefs: d })),
    ...
    function ad(t, e) {
        ...
        if (
            ((0, ts.eachItem)(t, (s) => {
                ...
                if (!od.test(s)) throw new Error(`Keyword ${s} has invalid name`);
            }),
    ...
    var ud = { $ref: 'https://raw.githubusercontent.com/ajv-validator/ajv/master/lib/refs/data.json#' };
    function qo(t) {
        return { anyOf: [t, ud] };
    }
});
...
var Uo = g((Te) => {
        ...
        fd = {
            ...
            code(t) {
                let { gen: e, schema: r, it: s } = t,
                    ...
                    { root: d } = o;
                if ((r === '#' || r === '#/') && n === d.baseId) return l();
                let u = Mo.resolveRef.call(c, d, n, r);
                if (u === void 0) throw new ld.default(s.opts.uriResolver, n, r);
                if (u instanceof Mo.SchemaEnv) return y(u);
                return m(u);
                function l() {
                    if (o === d) return Ht(t, a, o, o.$async);
                    let h = e.scopeValue('root', { ref: d });
                    return Ht(t, (0, B._)`${h}.validate`, d, d.$async);
                }
                function y(h) {
                    let f = Do(t, h);
                    Ht(t, f, h, h.$async);
    ...
    function Ht(t, e, r, s) {
        let { gen: n, it: o } = t,
            ...
            d = c.passContext ? Ke.default.this : B.nil;
        s ? u() : l();
        function u() {
            ...
            n.try(
                () => {
                    n.code((0, B._)`await ${(0, jo.callValidateCode)(t, e, d)}`), m(e), a || n.assign(h, !0);
                },
                (f) => {
...
var Vo = g((ss) => {
    ...
    var hd = Ao(),
        pd = Uo(),
        md = ['$schema', '$id', '$defs', '$vocabulary', { keyword: '$comment' }, 'definitions', hd.default, pd.default];
    ss.default = md;
});
var xo = g((ns) => {
    'use strict';
            ...
            code(t) {
                let { keyword: e, data: r, schemaCode: s, it: n } = t,
                    ...
                    a =
                        n.opts.unicode === !1
                            ? (0, qe._)`${r}.length`
                            : (0, qe._)`${(0, vd.useFunc)(t.gen, wd.default)}(${r})`;
        ...
        Nd = {
            ...
            code(t) {
                let { data: e, $data: r, schema: s, schemaCode: n, it: o } = t,
                    ...
                    i = r ? (0, Wt._)`(new RegExp(${n}, ${a}))` : (0, Sd.usePattern)(t, s);
                ...
                if ((a.allErrors ? d() : u(), i.strictRequired)) {
                    ...
                    for (let f of r)
                        if (m?.[f] === void 0 && !h.has(f)) {
                            ...
                            (0, kd.checkStrictMode)(a, _, a.opts.strictRequired);
                        }
                }
                function d() {
                    if (c || o) t.block$data(_t.nil, l);
...
var Bt = g((fs) => {
    ...
    var Bo = Dr();
    Bo.code = 'require("ajv/dist/runtime/equal").default';
    fs.default = Bo;
});
var Qo = g((ps) => {
    'use strict';
    ...
    var hs = ot(),
        ...
        Dd = {
            ...
            code(t) {
                ...
                if (!s && !n) return;
                let c = e.let('valid'),
                    d = o.items ? (0, hs.getSchemaTypes)(o.items) : [];
                t.block$data(c, u, (0, x._)`${a} === false`), t.ok(c);
                function u() {
                    let h = e.let('i', (0, x._)`${r}.length`),
                        f = e.let('j');
                    t.setParams({ i: h, j: f }), e.assign(c, !0), e.if((0, x._)`${h} > 1`, () => (l() ? y : m)(h, f));
                }
                function l() {
                ...
                function y(h, f) {
                    let p = e.name('item'),
                        _ = (0, hs.checkDataTypes)(d, p, i.opts.strictNumbers, hs.DataType.Wrong),
                        I = e.const('indices', (0, x._)`{}`);
                    e.for((0, x._)`;${h}--;`, () => {
                        e.let(p, (0, x._)`${r}[${h}]`),
                            e.if(_, (0, x._)`continue`),
                            d.length > 1 && e.if((0, x._)`typeof ${p} == "string"`, (0, x._)`${p} += "_"`),
                            e
                ...
                function m(h, f) {
                    let p = (0, Ad.useFunc)(e, jd.default),
                        _ = e.name('outer');
...
var Xo = g((ys) => {
    ...
    var ms = S(),
        Ud = T(),
        Vd = Bt(),
        xd = { message: 'must be equal to constant', params: ({ schemaCode: t }) => (0, ms._)`{allowedValue: ${t}}` },
        zd = {
            keyword: 'const',
            $data: !0,
            error: xd,
            code(t) {
                ...
                s || (o && typeof o == 'object')
                    ? t.fail$data((0, ms._)`!${(0, Ud.useFunc)(e, Vd.default)}(${r}, ${n})`)
                    : t.fail((0, ms._)`${o} !== ${r}`);
            },
        };
    ys.default = zd;
        ...
        Hd = {
            ...
            code(t) {
                ...
                let i = n.length >= a.opts.loopEnum,
                    c,
                    d = () => c ?? (c = (0, Ld.useFunc)(e, Fd.default)),
                    u;
                if (i || s) (u = e.let('valid')), t.block$data(u, l);
                else {
                ...
                function l() {
                    e.assign(u, !1),
                        e.forOf('v', o, (m) => e.if((0, vt._)`${d()}(${r}, ${m})`, () => e.assign(u, !0).break()));
                }
                function y(m, h) {
                    let f = n[h];
...
var vs = g((wt) => {
    ...
    function ea(t, e) {
        ...
        else if (typeof s == 'object' && !(0, $s.alwaysValidSchema)(a, s)) {
            let d = r.var('valid', (0, Ce._)`${i} <= ${e.length}`);
            r.if((0, Ce.not)(d), () => c(d)), t.ok(d);
        }
        function c(d) {
            r.forRange('i', e.length, i, (u) => {
                t.subschema({ keyword: o, dataProp: u, dataPropType: $s.Type.Num }, d),
                    a.allErrors || r.if((0, Ce.not)(d), () => r.break());
            });
        }
    }
    wt.validateAdditionalItems = ea;
    wt.default = nl;
});
var ws = g((Et) => {
    'use strict';
    ...
    var ta = S(),
        ...
        al = {
            ...
            code(t) {
                let { schema: e, it: r } = t;
                if (Array.isArray(e)) return ra(t, 'additionalItems', e);
                (r.items = !0), !(0, Qt.alwaysValidSchema)(r, e) && t.ok((0, ol.validateArray)(t));
            },
        };
    function ra(t, e, r = t.schema) {
        ...
        let c = s.name('valid'),
            d = s.const('len', (0, ta._)`${o}.length`);
        r.forEach((l, y) => {
            (0, Qt.alwaysValidSchema)(i, l) ||
                (s.if((0, ta._)`${d} > ${y}`, () => t.subschema({ keyword: a, schemaProp: y, dataProp: y }, c)),
                t.ok(c));
        });
        function u(l) {
...
var oa = g((bs) => {
    ...
    var na = S(),
        ...
        ll = vs(),
        fl = {
            message: ({ params: { len: t } }) => (0, na.str)`must NOT have more than ${t} items`,
            params: ({ params: { len: t } }) => (0, na._)`{limit: ${t}}`,
        },
        hl = {
            keyword: 'items',
            type: 'array',
            ...
            code(t) {
                let { schema: e, parentSchema: r, it: s } = t,
                    { prefixItems: n } = r;
                (s.items = !0),
                    !(0, ul.alwaysValidSchema)(s, e) &&
                        (n ? (0, ll.validateAdditionalItems)(t, n) : t.ok((0, dl.validateArray)(t)));
            },
        };
    bs.default = hl;
});
        ...
        ml = {
            ...
            code(t) {
                ...
                i === void 0 && a === 1
                    ? m(l, () => e.if(l, () => e.break()))
                    : a === 0
                      ? (e.let(l, !0), i !== void 0 && e.if((0, Z._)`${n}.length > 0`, y))
                      : (e.let(l, !1), y()),
                    t.result(l, () => t.reset());
                function y() {
                    let f = e.name('_valid'),
                ...
                function h(f) {
                    e.code((0, Z._)`${f}++`),
                        i === void 0
                            ? e.if((0, Z._)`${f} >= ${a}`, () => e.assign(l, !0).break())
                            : (e.if((0, Z._)`${f} > ${i}`, () => e.assign(l, !1).break()),
                              a === 1 ? e.assign(l, !0) : e.if((0, Z._)`${f} >= ${a}`, () => e.assign(l, !0)));
                }
            },
        };
    Ss.default = ml;
...
var ua = g((ue) => {
    ...
    ue.error = {
        ...
        params: ({ params: { property: t, depsCount: e, deps: r, missingProperty: s } }) => (0, Ps._)`{property: ${t},
    missingProperty: ${s},
    depsCount: ${e},
    deps: ${r}}`,
    };
    ...
    function ia(t, e = t.schema) {
        ...
        for (let a in e) {
            ...
            t.setParams({ property: a, depsCount: i.length, deps: i.join(', ') }),
                n.allErrors
                    ? r.if(c, () => {
                          for (let d of i) (0, bt.checkReportMissingProp)(t, d);
                      })
                    : (r.if((0, Ps._)`${c} && (${(0, bt.checkMissingProp)(t, i, o)})`),
                      (0, bt.reportMissingProp)(t, o),
                      r.else());
        }
    }
    ue.validatePropertyDeps = ia;
    function ca(t, e = t.schema) {
        let { gen: r, data: s, keyword: n, it: o } = t,
            a = r.name('valid');
        for (let i in e)
            (0, yl.alwaysValidSchema)(o, e[i]) ||
                (r.if(
    ...
    var da = S(),
        ...
        wl = {
            ...
            code(t) {
                ...
                if ((0, $l.alwaysValidSchema)(n, r)) return;
                let o = e.name('valid');
                e.forIn('key', s, (a) => {
    ...
    var Yt = X(),
        ...
        Sl = {
            ...
            code(t) {
                ...
                let d = (0, Yt.allSchemaProperties)(s.properties),
                    u = (0, Yt.allSchemaProperties)(s.patternProperties);
                l(), t.ok((0, se._)`${o} === ${El.default.errors}`);
                function l() {
                    e.forIn('key', n, (p) => {
                        !d.length && !u.length ? h(p) : e.if(y(p), () => h(p));
                    });
                }
                function y(p) {
                    let _;
                    ...
                    } else d.length ? (_ = (0, se.or)(...d.map((I) => (0, se._)`${p} === ${I}`))) : (_ = se.nil);
                    return (
                        u.length &&
        ...
        Nl = {
            ...
            code(t) {
                ...
                o.opts.removeAdditional === 'all' &&
                    ...
                    ha.default.code(new Pl.KeywordCxt(o, ha.default, 'additionalProperties'));
                let a = (0, fa.allSchemaProperties)(r);
                for (let l of a) o.definedProperties.add(l);
                o.opts.unevaluated &&
                    a.length &&
                    o.props !== !0 &&
                    (o.props = ks.mergeEvaluated.props(e, (0, ks.toHash)(a), o.props));
                let i = a.filter((l) => !(0, ks.alwaysValidSchema)(o, r[l]));
                if (i.length === 0) return;
                let c = e.name('valid');
                for (let l of i)
                    d(l)
                        ? u(l)
                        : (e.if((0, fa.propertyInData)(e, n, l, o.opts.ownProperties)),
                          u(l),
        ...
        Rl = {
            ...
            code(t) {
                let { gen: e, schema: r, data: s, parentSchema: n, it: o } = t,
                    { opts: a } = o,
                    i = (0, ma.allSchemaProperties)(r),
                    c = i.filter((f) => (0, ya.alwaysValidSchema)(o, r[f]));
                if (i.length === 0 || (c.length === i.length && (!o.opts.unevaluated || o.props === !0))) return;
                let d = a.strictSchema && !a.allowMatchingProperties && n.properties,
                    u = e.name('valid');
                o.props !== !0 && !(o.props instanceof er.Name) && (o.props = (0, ga.evaluatedPropsToName)(e, o.props));
                let { props: l } = o;
                y();
                function y() {
                    for (let f of i) d && m(f), o.allErrors ? h(f) : (e.var(u, !0), h(f), e.if(u));
                }
                function m(f) {
                    for (let p in d)
                        new RegExp(f).test(p) &&
                            (0, ya.checkStrictMode)(
                                o,
                ...
                function h(f) {
                    e.forIn('key', s, (p) => {
                        e.if((0, er._)`${(0, ma.usePattern)(t, f)}.test(${p})`, () => {
                            let _ = c.includes(f);
                            _ ||
                                t.subschema(
                                    {
                        ...
                        (0, ql.alwaysValidSchema)(n, u)
                            ...
                            l > 0 &&
                                e
                                    ...
                                    .else(),
                            e.if(c, () => {
                                e.assign(a, !0), e.assign(i, l), y && t.mergeEvaluated(y, tr.Name);
                            });
                    });
                }
            },
    ...
    var jl = T(),
        Ml = {
            ...
            code(t) {
                ...
                let n = e.name('valid');
                r.forEach((o, a) => {
                    if ((0, jl.alwaysValidSchema)(s, o)) return;
...
var Pa = g((Ms) => {
    ...
    var rr = S(),
        ...
        Ul = {
            ...
            code(t) {
                ...
                r.then === void 0 &&
                    r.else === void 0 &&
                    (0, Sa.checkStrictMode)(s, '"if" without "then" and "else" is ignored');
                let n = ba(s, 'then'),
                    o = ba(s, 'else');
                if (!n && !o) return;
                let a = e.let('valid', !0),
                ...
                if ((c(), t.reset(), n && o)) {
                    ...
                    t.setParams({ ifClause: u }), e.if(i, d('then', u), d('else', u));
                } else n ? e.if(i, d('then')) : e.if((0, rr.not)(i), d('else'));
                t.pass(a, () => t.error(!0));
                function c() {
                ...
                function d(u, l) {
                    return () => {
                        ...
                        e.assign(a, i),
                            ...
                            l ? e.assign(l, (0, rr._)`${u}`) : t.setParams({ ifClause: u });
                    };
                }
            },
        };
    function ba(t, e) {
        let r = t.schema[e];
        return r !== void 0 && !(0, Sa.alwaysValidSchema)(t, r);
    }
    Ms.default = Ul;
});
var Na = g((Ds) => {
    ...
    var Vl = T(),
        xl = {
            ...
            code({ keyword: t, parentSchema: e, it: r }) {
                e.if === void 0 && (0, Vl.checkStrictMode)(r, `"${t}" without "if" is ignored`);
            },
        };
    Ds.default = xl;
});
var Ra = g((Us) => {
    ...
    function sf(t = !1) {
        ...
        return t ? e.push(Ll.default, Kl.default) : e.push(zl.default, Fl.default), e.push(Hl.default), e;
    }
    Us.default = sf;
});
var Ia = g((Vs) => {
        ...
        of = {
            ...
            code(t, e) {
                let { gen: r, data: s, $data: n, schema: o, schemaCode: a, it: i } = t,
                    { opts: c, errSchemaPath: d, schemaEnv: u, self: l } = i;
                        ...
                        let ne =
                                w instanceof RegExp
                                    ...
                                    : c.code.formats
                                      ...
                                      : void 0,
                            de = r.scopeValue('formats', { key: o, ref: w, code: ne });
                        return typeof w == 'object' && !(w instanceof RegExp)
                            ? [w.type || 'string', w.validate, (0, D._)`${de}.validate`]
                            : ['string', w, de];
                    }
                    function A() {
...
var qa = g((zs) => {
    ...
    var uf = Vo(),
        ...
        ff = ka(),
        Ta = Oa(),
        hf = [uf.default, df.default, (0, lf.default)(), ff.default, Ta.metadataVocabulary, Ta.contentVocabulary];
    zs.default = hf;
});
var Aa = g((sr) => {
    'use strict';
    ...
    var Ge = S(),
        ...
        yf = {
            message: ({ params: { discrError: t, tagName: e } }) =>
                t === Ls.DiscrError.Tag ? `tag "${e}" must be string` : `value of tag "${e}" must be in oneOf`,
        ...
        gf = {
            ...
            code(t) {
                ...
                let c = e.let('valid', !1),
                    d = e.const('tag', (0, Ge._)`${r}${(0, Ge.getProperty)(i)}`);
                e.if(
                    (0, Ge._)`typeof ${d} == "string"`,
                    () => u(),
                    () => t.error(!1, { discrError: Ls.DiscrError.Tag, tag: d, tagName: i }),
                ),
                    t.ok(c);
                function u() {
                    let m = y();
                    e.if(!1);
                    for (let h in m) e.elseIf((0, Ge._)`${d} === ${h}`), e.assign(c, l(m[h]));
                    e.else(), t.error(!1, { discrError: Ls.DiscrError.Mapping, tag: d, tagName: i }), e.endIf();
                }
                function l(m) {
                    let h = e.name('valid'),
                ...
                function y() {
                    ...
                    for (let A = 0; A < a.length; A++) {
                        ...
                        if (w?.$ref && !(0, mf.schemaHasRulesButRef)(w, o.self.RULES)) {
                            let de = w.$ref;
                            if (
                                ((w = ja.resolveRef.call(o.self, o.schemaEnv.root, o.baseId, de)),
                                w instanceof ja.SchemaEnv && (w = w.schema),
                                w === void 0)
                            )
                                throw new pf.default(o.opts.uriResolver, o.baseId, de);
                        }
    ...
    var $f = Co(),
        ...
        Je = class extends $f.default {
            ...
            _addDefaultMetaSchema() {
                ...
                let e = this.opts.$data ? this.$dataMetaSchema(Ua, Ef) : Ua;
...
var If = {};
Ba(If, { handleHttp: () => Rf, schema: () => La });
module.exports = Xa(If);
var ye = {
...
var Bs = (t) => ({ statusCode: 404, headers: ye, body: t ? JSON.stringify(t) : 'Not Found' }),
    Qs = (t) => ({ statusCode: 422, headers: ye, body: t ? JSON.stringify(t) : 'Unprocessable Entity' }),
    Xs = (t) => (t.statusCode ? t : (console.error(t), { statusCode: 500, headers: ye, body: t.message }));
var Mf = oe({
    ...
    Vf = oe({ name: 'InvalidRefreshTokenError', message: 'Refresh token is invalid.' }),
    xf = oe({ name: 'VerificationCodeMismatchError', message: 'The verification code does not match.' }),
    zf = Ae({
    ...
    Ys = Bs({ name: 'UserNotFoundError', message: 'No user was found under the given email or user ID.' }),
    Zs = Ae({ name: 'UserNotVerifiedError', message: 'The user must be verified with Register Verify operation.' }),
    ...
    en = Ae({ name: 'PasswordResetRequiredError', message: 'The password must be reset.' }),
    Kf = Qs({
...
var rn = process.env.AWS_REGION || '',
    ...
    Gf = process.env.CLOUDFRONT_ACCESS_KEY_ID || '',
    Jf = process.env.CLOUDFRONT_NEW_ACCESS_KEY_PARAMETER || '',
    Wf = process.env.INVITE_USER_VALIDATION_VIEW || '',
    Bf = process.env.PULL_LAMBDA_NAME || '',
    Qf = process.env.MEDIA_DOMAIN || '',
...
var ti = new U.CognitoIdentityProviderClient({ region: rn, apiVersion: 'latest' });
var nn = async (t, e, r, s) => {
    let n = new U.RespondToAuthChallengeCommand({
            ClientId: sn,
            ChallengeName: 'PASSWORD_VERIFIER',
            ChallengeResponses: {
                USERNAME: t,
                TIMESTAMP: s,
                PASSWORD_CLAIM_SECRET_BLOCK: e,
                PASSWORD_CLAIM_SIGNATURE: r,
            },
        }),
        o = await ti.send(n);
    return {
        accessToken: o?.AuthenticationResult?.AccessToken,
        expiresIn: o?.AuthenticationResult?.ExpiresIn,
        idToken: o?.AuthenticationResult?.IdToken,
        refreshToken: o?.AuthenticationResult?.RefreshToken,
    };
};
var xa = Qa(Va(), 1);
var za = async (t, e) => {
...
var La = {
    ...
    Nf = async ({ body: t }) => {
        let { userId: e, secretBlock: r, signature: s, timestamp: n } = t;
        try {
            let o = await nn(e, r, s, n);
            return { statusCode: 200, headers: ye, body: JSON.stringify(o) };
        } catch (o) {
            switch (o.name) {
