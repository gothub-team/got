...
var login_verify_exports = {};
__export(login_verify_exports, {
  handleHttp: () => handleHttp,
  schema: () => schema
});
module.exports = __toCommonJS(login_verify_exports);
...
var cognitoRespondVerifySrp = async (userId, secretBlock, signature, timestamp) => {
