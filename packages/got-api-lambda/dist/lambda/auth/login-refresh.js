...
var login_refresh_exports = {};
__export(login_refresh_exports, {
  handleHttp: () => handleHttp,
  schema: () => schema
});
module.exports = __toCommonJS(login_refresh_exports);
...
var cognitoInitiateAuthRefreshToken = async (refreshToken) => {
