...
var g = (t, e) => () => (e || t((e = { exports: {} }).exports, e), e.exports),
    ...
    Js = (t, e, r, s) => {
        if ((e && typeof e == 'object') || typeof e == 'function')
            for (let n of Ga(e))
                !Wa.call(t, n) && n !== r && Pt(t, n, { get: () => e[n], enumerable: !(s = Ha(e, n)) || s.enumerable });
        return t;
    };
var Qa = (t, e, r) => (
        (r = t != null ? Ka(Ja(t)) : {}),
        Js(e || !t || !t.__esModule ? Pt(r, 'default', { value: t, enumerable: !0 }) : r, t)
    ),
    Xa = (t) => Js(Pt({}, '__esModule', { value: !0 }), t);
var Ye = g((O) => {
    'use strict';
    ...
    O.str = an;
    function ur(t, e) {
        e instanceof Q ? t.push(...e._items) : e instanceof Pe ? t.push(e) : t.push(oi(e));
    }
    O.addCodeArg = ur;
    function ri(t) {
        let e = 1;
...
var T = g((S) => {
    ...
    S.escapeJsonPointer = Nr;
    function pn(t) {
        return t.replace(/~1/g, '/').replace(/~0/g, '~');
    }
    S.unescapeJsonPointer = pn;
    function bi(t, e) {
        if (Array.isArray(t)) for (let r of t) e(r);
        else e(t);
    }
    S.eachItem = bi;
    function ln({ mergeNames: t, mergeToName: e, mergeValues: r, resultToName: s }) {
        return (n, o, a, i) => {
            let c =
                a === void 0
                    ? o
    ...
    var dn = {};
    function Pi(t, e) {
        return t.scopeValue('func', { ref: e, code: dn[e.code] || (dn[e.code] = new yi._Code(e.code)) });
    }
    S.useFunc = Pi;
    var Sr;
    (function (t) {
...
var nt = g((L) => {
    ...
    function Ai(t, { params: e, message: r }, s) {
        ...
        s.push([Ie.keyword, n], [Ie.params, typeof e == 'function' ? e(t) : e || (0, k._)`{}`]),
            ...
            c.verbose && s.push([Ie.schema, a], [Ie.parentSchema, (0, k._)`${u}${d}`], [K.default.data, o]),
...
var ot = g((F) => {
    ...
    function Yi(t, e, r) {
        ...
        for (let l of r) (Nn.has(l) || (l === 'array' && o.coerceTypes === 'array')) && c(l);
        s.else(),
            Cr(t),
            s.endIf(),
            s.if((0, E._)`${i} !== undefined`, () => {
...
var X = g((q) => {
    ...
    function hc(t) {
        ...
        function a(i) {
            ...
            e.forRange('i', 0, c, (l) => {
                t.subschema({ keyword: s, dataProp: l, dataPropType: Ar.Type.Num }, o), e.if((0, j.not)(o), i);
            });
        }
    }
    q.validateArray = hc;
...
var jn = g((ve) => {
    ...
    ve.getSubschema = bc;
    function Pc(t, e, { dataProp: r, dataPropType: s, data: n, dataTypes: o, propertyName: a }) {
        ...
        if (r !== void 0) {
            ...
            c(y),
                (t.errorPath = (0, ie.str)`${l}${(0, An.getErrorPath)(r, s, d.jsPropertySyntax)}`),
    ...
    ve.extendSubschemaData = Pc;
    function Sc(t, { jtdDiscriminator: e, jtdMetadata: r, compositeRule: s, createErrors: n, allErrors: o }) {
...
var Vt = g((Y) => {
    ...
    function Wr(t) {
        ...
        try {
            ...
            let d = a.toString();
            (u = `${a.scopeRefs(Oe.default.scope)}return ${d}`),
...
var wo = g((Vh, vo) => {
    ...
    var $o = { scheme: 'http', domainHost: !0, parse: go, serialize: _o },
        ...
        xt = { scheme: 'ws', domainHost: !0, parse: Pu, serialize: Su },
...
var Co = g((V) => {
    ...
    var pt = class {
        ...
        addKeyword(e, r) {
            ...
            if ((al.call(this, s, r), !r)) return (0, ts.eachItem)(s, (o) => es.call(this, o)), this;
            cl.call(this, r);
...
var Uo = g((Te) => {
    ...
    var dl = lt(),
        ...
        fl = {
            ...
            code(t) {
                ...
                let u = Mo.resolveRef.call(c, l, n, r);
    ...
    function Ht(t, e, r, s) {
        ...
        function u() {
            ...
            n.try(
                () => {
                    n.code((0, B._)`await ${(0, jo.callValidateCode)(t, e, l)}`), m(e), a || n.assign(h, !0);
                },
                (f) => {
        ...
        Nl = {
            ...
            code(t) {
                let { data: e, $data: r, schema: s, schemaCode: n, it: o } = t,
                    ...
                    i = r ? (0, Wt._)`(new RegExp(${n}, ${a}))` : (0, Pl.usePattern)(t, s);
                ...
                if ((a.allErrors ? l() : u(), i.strictRequired)) {
                    ...
                    for (let f of r)
                        if (m?.[f] === void 0 && !h.has(f)) {
                            ...
                            (0, kl.checkStrictMode)(a, _, a.opts.strictRequired);
                        }
                }
                function l() {
    ...
    var hs = ot(),
        ...
        Dl = {
            ...
            code(t) {
                ...
                if (!s && !n) return;
                let c = e.let('valid'),
                    l = o.items ? (0, hs.getSchemaTypes)(o.items) : [];
                ...
                function y(h, f) {
                    let p = e.name('item'),
                        _ = (0, hs.checkDataTypes)(l, p, i.opts.strictNumbers, hs.DataType.Wrong),
...
var Xo = g((ys) => {
    ...
    var ms = P(),
        Ul = T(),
        Vl = Bt(),
        xl = { message: 'must be equal to constant', params: ({ schemaCode: t }) => (0, ms._)`{allowedValue: ${t}}` },
        zl = {
            keyword: 'const',
            $data: !0,
            error: xl,
            code(t) {
                ...
                s || (o && typeof o == 'object')
                    ? t.fail$data((0, ms._)`!${(0, Ul.useFunc)(e, Vl.default)}(${r}, ${n})`)
                    : t.fail((0, ms._)`${o} !== ${r}`);
            },
        };
    ys.default = zl;
    ...
    function ea(t, e) {
        ...
        function c(l) {
            r.forRange('i', e.length, i, (u) => {
                t.subschema({ keyword: o, dataProp: u, dataPropType: $s.Type.Num }, l),
...
var ws = g((Et) => {
    ...
    function ra(t, e, r = t.schema) {
        ...
        let c = s.name('valid'),
            l = s.const('len', (0, ta._)`${o}.length`);
        r.forEach((d, y) => {
            (0, Qt.alwaysValidSchema)(i, d) ||
                (s.if((0, ta._)`${l} > ${y}`, () => t.subschema({ keyword: a, schemaProp: y, dataProp: y }, c)),
                t.ok(c));
        });
        function u(d) {
...
var ua = g((ue) => {
    ...
    ue.error = {
        message: ({ params: { property: t, depsCount: e, deps: r } }) => {
            ...
            return (0, Ss.str)`must have ${s} ${r} when property ${t} is present`;
        },
        params: ({ params: { property: t, depsCount: e, deps: r, missingProperty: s } }) => (0, Ss._)`{property: ${t},
    missingProperty: ${s},
    depsCount: ${e},
    deps: ${r}}`,
    };
        ...
        for (let a in e) {
            ...
            t.setParams({ property: a, depsCount: i.length, deps: i.join(', ') }),
                n.allErrors
                    ...
                    : (r.if((0, Ss._)`${c} && (${(0, bt.checkMissingProp)(t, i, o)})`),
...
var da = g((Ns) => {
    ...
    var la = P(),
        ...
        vd = {
            ...
            params: ({ params: t }) => (0, la._)`{propertyName: ${t.propertyName}}`,
        },
        wd = {
        ...
        Nd = {
            ...
            code(t) {
                ...
                o.opts.removeAdditional === 'all' &&
                    ...
                    ha.default.code(new Sd.KeywordCxt(o, ha.default, 'additionalProperties'));
                ...
                for (let d of i)
                    l(d)
                        ? u(d)
                        : (e.if((0, fa.propertyInData)(e, n, d, o.opts.ownProperties)),
                          u(d),
...
var qa = g((zs) => {
    ...
    var uf = Vo(),
        ...
        ff = ka(),
        Ta = Oa(),
        hf = [uf.default, lf.default, (0, df.default)(), ff.default, Ta.metadataVocabulary, Ta.contentVocabulary];
    zs.default = hf;
});
var Aa = g((sr) => {
    'use strict';
        ...
        gf = {
            ...
            code(t) {
                ...
                e.if(
                    ...
                    () => u(),
                    () => t.error(!1, { discrError: Ls.DiscrError.Tag, tag: l, tagName: i }),
                ),
                    t.ok(c);
                function u() {
                    let m = y();
                    ...
                    e.else(), t.error(!1, { discrError: Ls.DiscrError.Mapping, tag: l, tagName: i }), e.endIf();
                }
                function d(m) {
                    let h = e.name('valid'),
                ...
                function y() {
                    ...
                    for (let A = 0; A < a.length; A++) {
                        ...
                        if (w?.$ref && !(0, mf.schemaHasRulesButRef)(w, o.self.RULES)) {
                            let le = w.$ref;
                            if (
                                ((w = ja.resolveRef.call(o.self, o.schemaEnv.root, o.baseId, le)),
...
var Mf = oe({
    ...
    Ys = oe({ name: 'InvalidRefreshTokenError', message: 'Refresh token is invalid.' }),
    ...
    Zs = Bs({ name: 'UserNotFoundError', message: 'No user was found under the given email or user ID.' }),
    en = Ae({ name: 'UserNotVerifiedError', message: 'The user must be verified with Register Verify operation.' }),
    zf = Ae({ name: 'UserExistsError', message: 'There is an existing user with the given email address.' }),
    Lf = oe({
        name: 'UserMissingPasswordChallengeError',
        message: 'The user must have an active require password change challenge.',
    }),
    tn = Ae({ name: 'PasswordResetRequiredError', message: 'The password must be reset.' }),
    Ff = Qs({
...
var nn = async (t) => {
    let e = new U.InitiateAuthCommand({
            ClientId: sn,
            AuthFlow: 'REFRESH_TOKEN_AUTH',
            AuthParameters: { REFRESH_TOKEN: t },
        }),
        r = await ti.send(e);
    return {
...
var La = {
    ...
    Nf = async ({ body: t }) => {
        let { refreshToken: e } = t;
        try {
            let r = await nn(e);
            return { statusCode: 200, headers: ye, body: JSON.stringify(r) };
        } catch (r) {
            switch (r.name) {
