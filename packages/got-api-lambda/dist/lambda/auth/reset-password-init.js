...
var reset_password_init_exports = {};
__export(reset_password_init_exports, {
  handleHttp: () => handleHttp,
  schema: () => schema
});
module.exports = __toCommonJS(reset_password_init_exports);
...
var cognitoForgotPassword = async (email, skipMessage = false) => {
  const command = new import_client_cognito_identity_provider.ForgotPasswordCommand({
    ClientId: CLIENT_ID,
    Username: email,
    ClientMetadata: {
