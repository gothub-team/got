...
var register_init_exports = {};
__export(register_init_exports, {
  handleHttp: () => handleHttp,
  schema: () => schema
});
module.exports = __toCommonJS(register_init_exports);
...
var cognitoSignup = async (email, password, skipMessage = false) => {
