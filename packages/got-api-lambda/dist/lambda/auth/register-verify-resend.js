...
var register_verify_resend_exports = {};
__export(register_verify_resend_exports, {
  handleHttp: () => handleHttp,
  schema: () => schema
});
module.exports = __toCommonJS(register_verify_resend_exports);
...
var cognitoResendConfirmationCode = async (email) => {
  const command = new import_client_cognito_identity_provider.ResendConfirmationCodeCommand({
    ClientId: CLIENT_ID,
    Username: email
  });
