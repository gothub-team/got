...
// src/handler/get-logs.ts
var get_logs_exports = {};
__export(get_logs_exports, {
  handleHttp: () => handleHttp,
  schema: () => schema
});
module.exports = __toCommonJS(get_logs_exports);
...
var s3list = async (bucket, prefix) => {
...
var handle = async ({ userEmail, body }) => {
