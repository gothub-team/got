...
export class UserPool extends pulumi.ComponentResource {
    /** @internal */
    public static readonly __pulumiType = 'gotiac:index:UserPool';
    ...
    constructor(name: string, args?: UserPoolArgs, opts?: pulumi.ComponentResourceOptions) {
        ...
        super(UserPool.__pulumiType, name, resourceInputs, opts, true /*remote*/);
    }
}
