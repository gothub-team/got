...
exports.callAsync =
    exports.lazyLoad =
    exports.resourceOptsDefaults =
    exports.getVersion =
    exports.getEnvNumber =
    exports.getEnvBoolean =
    exports.getEnv =
        void 0;
...
function resourceOptsDefaults() {
    return {
        version: getVersion(),
        pluginDownloadURL: 'https://github.com/gothub-team/got/releases/download/packages/pulumi-gotiac-aws/v0.1.9',
    };
}
...
function callAsync(tok, props, res, opts) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const problem = !isKnown ? 'an unknown value' : isSecret ? 'a secret value' : undefined;
